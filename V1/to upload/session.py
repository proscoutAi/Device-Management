...
from gps_manager import get_gps_data_dual
import sys
...
class Session:
    ...
    def run(self):
        ...
        while self.running:
            ...
            print(f"lat:{gp_dual['latitude']} lon:{gp_dual['longitude']}")
            image = None
            ...
            executor.submit(self.upload_class.upload_json, snap_time, litter_per_hour, gp_dual, image,gp_dual)
